...
def printer(pvalue, ids, names, parents, costs, times, exploiteds, countermeasures, children, connectors, probabilities, difficulties, new_file_name):
    ...
    # Writes the JESS program into its own file.
        ...
        with open('Attack_Trees/JESS/' + new_file_name + '.clp', 'w') as f:
            f.write(';;;====================================================== '
                    ...
                    '\n;;;    '
                    '\n;;;   ATES was reated by Jon Salter at VGTU '
                    '\n;;;    Jonathan-Steven.Salter@stud.vgtu.lt '
                    '\n;;;    '
                    ...
                    '\n		(default "")))'
                    '\n\n;;;;;;;;;;;;;;;;;;;;;')
            # Writes the data in a single file for version 1.
            if pvalue == 1:
            ...
            # writes the data in two files for version 2.
            elif pvalue == 2:
                f.write('\n; Fact template for JESS program:'
                        ...
                        f'\n(require* "Attack_Trees/JESS/{new_file_name}.dat")'
                        '\n\n;;;;;;;;;;;;;;;;;;;;'
                        ...
                        '\n	=>'
                        f'\n	(load-facts "Attack_Trees/JESS/{new_file_name}.dat")'
                        '\n	(facts)'
                        ...
                        '\n	(remove question)'
                        '\n	(remove initial-fact)'
                        f'\n	(save-facts "Attack_Trees/JESS/{new_file_name}.dat")'
                        '\n	(exit))'
                        '\n'
                        '\n(defrule view-at'
                        '\n	(program)'
                        ...
                        '\n\n;;;;;;;;;;;;;;;;;;;;;'
                        '\n\n(reset)\n(run)\n')
                with open('Attack_Trees/JESS/' + new_file_name + '.dat', 'w') as g:
                    g.write(f'(MAIN::tree (tname "{treename}") (rootnode "{names[0]}"))')
                    # Writes the data for each node into its own JESS fact.
                    while i < len(ids):
